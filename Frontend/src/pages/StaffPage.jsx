...
export function StaffPage({ currentUser }) {
  const [activeTab, setActiveTab] = useState('employees'); // employees | attendance | loans | payroll
    ...
    <div className="space-y-6">
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 shadow-sm">
        ...
        <div className="flex flex-wrap items-center gap-2 mt-6 pt-4 border-t border-slate-800/80">
          ...
          >
            <Users size={16} /> Staff Directory ({employees.length})
          </button>
          ...
          >
            <Clock size={16} /> Daily Attendance Matrix
          </button>
          ...
          >
            <DollarSign size={16} /> Advance Loans Ledger
          </button>
          ...
          >
            <FileSpreadsheet size={16} /> Monthly Payroll & Slips
          </button>
        </div>
      </div>
