    ...
    const loadMaster = async () => {
      try {
        ...
        if (isMounted) {
          ...
          // Set default cash custodian or bank
    ...
    try {
      ...
      if (res.success) {
        Alert.alert(
          ...
          res.message ||
            `Voucher #${voucherNo} recorded as a temporary pending entry awaiting verification by Khurshid Anwar.`,
          [
            {
              text: 'View My Entries',
              onPress: () => router.replace('/(data-entry)/my-entries'),
            },
            {
              text: 'Record Another',
              onPress: async () => {
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      >
        ...
        >
          ...
          <View style={styles.card}>
            {/* Field: Property (Optional for general, required for property/unit) */}
            ...
            {/* Field: Unit Selection (Only if property is selected) */}
            {selectedProperty && (
              <View style={styles.fieldGroup}>
                <View style={styles.labelRow}>
      ...
      <AccountPickerModal
        ...
        title="Select Paid From Account"
        subtitle="Account where funds were disbursed from"
