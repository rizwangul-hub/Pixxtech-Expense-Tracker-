      ...
      try {
        ...
        if (isMounted) {
          ...
          if (fetchedUnits.length > 0) {
            ...
            // If default receiving account matches an account in accounts list
    ...
    try {
      ...
      if (res.success) {
        Alert.alert(
          ...
          res.message ||
            `Rent receipt of PKR ${numAmount.toLocaleString()} submitted as a pending entry. Awaiting verification by Khurshid Anwar.`,
          [
            {
        ...
        >
          ...
          <View style={styles.infoBanner}>
            ...
            <Text style={styles.infoBannerText}>
              Rent collected will be recorded as a pending submission awaiting verification by Khurshid Anwar.
            </Text>
          </View>
          ...
          <View style={styles.card}>
            ...
            {/* Unit Financial Overview Card (if unit selected) */}
            {selectedUnit && (
